...
use syn::{
    Attribute, Block, FnArg, ImplItem, ImplItemFn, ReturnType, TraitItem, TraitItemFn, Visibility,
    parse_quote,
};

use crate::{
    DataSpec, Spec,
    instrument::{Mode, find_spec_attr, make_item_error, patterns::sanitize_pat_as_expr},
};
