...
Specifications are a common ground across the ecosystem of Rust correctness tools. Anodized provides an ergonomic and expressive syntax for writing specs. Runtime checks are available today, and integration with other verification approaches like fuzz testing and formal verification on the roadmap.
